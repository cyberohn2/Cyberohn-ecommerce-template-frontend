  ...
  return (
    <div className="bg-[var(--red)] sm:p-8 p-4  text-white rounded-2xl relative">
      <div className="pb-40">
        ...
        <img width={10} className="absolute top-[3rem] sm:right-[30%] right-[20%] long-animate sm:w-[15%] w-[25%] hero-image shadowbox translate-x-[5rem] cursor-pointer transition-transform duration-300" src={heroImg} alt="pizz peanott drink" />
      </div>
