...
const Footer = () => {
  return (
    <div className="bg-[var(--darkblue)] p-4 text-white">
         ...
         <img className="mx-auto md:mx-0 mb-4 md:m-0" src={pizzLogoBw} alt="pizz bw logo" />
           <ul className="flex items-center gap-8 flex-col md:flex-row pb-8 mb-4 md:m-0 md:p-0 ">
        ...
        <p className="text-center">&copy; Pizz Treats 2025</p>
    </div>
  )
}
